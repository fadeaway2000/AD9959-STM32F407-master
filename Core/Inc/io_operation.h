...
#ifndef AD9959_IO_OPERATION_H
#define AD9959_IO_OPERATION_H

#define BIT_BAND(addr, bit_num) ((addr & 0xF0000000)+0x2000000+((addr &0xFFFFF)<<5)+(bit_num<<2))
